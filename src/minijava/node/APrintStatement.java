...
public final class APrintStatement extends PStatement
{
    ...
    public APrintStatement(
        @SuppressWarnings("hiding") TTokPrint _token_,
    ...
    public TTokPrint getToken()
    {
        return this._token_;
    }

    public void setToken(TTokPrint node)
    {
